//Шейдер для заюлюривания всего, что находиться за картинкой в UI
//Цвет пикселей картинки не учитывается и не применяется с блюром.

    Shader "UI/MaskedUIBlurWithoutImageColors" 
    {
        ...
        Properties 
        {
            ...
            _Distortion ("Distortion strenght", Range(0, 20)) = 1
        }
